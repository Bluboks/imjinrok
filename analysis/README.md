...
현재 스키마 2 기준선은 Ghidra 12.1.2가 원본 EXE에서 생성한 함수 2,448개, 문자열 1,545개,
내부 메모리 참조 57,572개, 간접 분기 후보 268개, 복원된 점프 테이블 234개와 seed 25개다.
2026-07-26에 전체 분석을 연속 두 번 실행해 여섯 JSON 파일의 SHA-256이 모두 일치함을 확인했다.
