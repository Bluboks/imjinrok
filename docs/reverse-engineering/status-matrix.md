...
| K01 source tile object·frame selector | K01 map `+0x3a3a4/+0x42234+x*180+y` → normal loader object/frame, 3,600 pair source/header bound 정적 확정 | 재현 완료 | 없음 | pixel placement/pivot, 다른 map/theme, terrain/passability/elevation/world 의미와 product renderer 연결 분석 |
...
| 낮·밤 팔레트 schedule | `imjin2`·`night1`~`night4` SHA/path/destination, `FUN_004924c0` state init, `FUN_00492510` 540/16 advance·7개 palette/event 순서, `FUN_004400b0` apply boundary와 `FUN_00492630` force branch 범위 정적 확정 | constructor·540/16 wrap·모든 event 순서·gate·변조 거부 재현 완료 | 분석 전용; 제품 day/night은 별도 의도적 적응 | wall-clock/24 Hz calibration, phase flag의 사람용 의미, sight·map enablement, true-color port와 force caller 복원 |
