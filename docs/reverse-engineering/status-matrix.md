...
| K01 봉화대 트리거 | raw-relation blocker→1,200-slot 완성 record scan→flag·K0120·native effect→post-state 반환과 native class·K01 요청 좌표, class-12/13/82 normal core·class-14 16-ring·creation-default destruction 범위 정적 확정 | trigger 분기·descriptor·selector·return 및 타입/SPR·요청 좌표 9개, class-12 animation vector와 class-14 turn/effect 경계 재현 완료 | K01 adapter 9개 모두 exact static identity/source; class 12·13·82 핵심 상태와 class 14 상태 8/1/4 grid animation 이식 | 행동·stats·class 12 state-2 policy·class 14 generic Facing/runtime tick mapping·owner·원본 생성/최종 배치 정책 뒤 isolated opt-in 확대 |
