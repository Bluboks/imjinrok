...
| K0110 briefing `TITLE`·`OBJECTIVE` overlay와 `SETDELAYTIME` | 정적 확정 | 범위 한정 재현 완료 | 분석 전용, production 변경 없음 | `CHANGETITLE` consumer와 outer update cadence를 별도로 복원한 뒤에만 wall-clock presentation을 비교 |
