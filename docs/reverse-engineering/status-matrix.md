...
| 전투·피해 | K01 일반 공격과 class 78 action 40, action 59 loop-carried full DWORD·fixed reset/tracking·subtype 16 helper-zero 후보/same-slot subtype 1 전환·mode 2 kind 2 및 subtype 12 kind 9 산식·low-active/class-95/full-generation/writer gate 정적 확정 | 일반 공격 제한 범위와 class 78 delivery·subtype 12/16 flight/종료·선택 buffer/health write 부분 재현 | 프로토타입, 자동 마법은 미이식 | generic mode 1 kind 2 callback, 재경로 좌표 결과, death/reference invalidation, 대상 검색·사거리, tick 초 환산 |
