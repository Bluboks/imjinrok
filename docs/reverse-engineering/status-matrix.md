...
| K01 시작 유닛 class 7·11·12·13·16·31 binding | K01 map active class 7·11·12·13·16·31 record, catalog 정체·primary SPR와 class 7·11·16 및 class 31 initializer/helper의 scoped core frame을 정적 확정 범위로 결합; class 7·31은 source-created `+0x47a==0` state 8/1/7 frame·direction·mirror만 포함 | canonical function·initializer·map·SPR 변조 거부와 record·frame vector 재현 완료 | class 7 `villager`와 class 31 `japanese-farmer`의 idle/move/walk/death 고유 visual을 부분 이식; gameplay/stats/commands는 기존 project adapter 유지 | class 7·31 state 4·nonzero branch, FPS/pivot/stats/behavior, source building proxy, owner/movement을 별도 정적 분석 |
...
| 애니메이션 | K01 class 2·3·4·7·11·12·13·16·31·82 scoped core states, class 14 상태 8/1/4와 16-ring·transient destruction, 두 영웅 상태 1·4·7·8 정적 확정; class 7·31은 source-created `+0x47a==0` state 8/1/7 frame·direction·mirror만 포함 | 방향·phase·상태별 슬롯·flags, class 14 turn/effect tick 경계와 K01 영웅 사망 완료/해제 경계 재현 | class 7·31 idle/move/walk/death와 class 2·3·4·11·12·13·14·16·82 grid 핵심 상태, 두 영웅 핵심 상태 이식 | class 7·31 state 4/nonzero branch·FPS/pivot/stats/behavior, class 2/3/4·12 state 2 project policy, 원본 update→FPS/24 Hz 변환, source building proxies |
...
- 95개 원본 타입의 정체·자원은 전수 확정했다. 현행 24개 비주얼 중 23개는 원본 타입 하나와
...
- 조선 본영과 봉화대 본체 상태 2개는 `scoped-static-proven`, 정체와 일부 또는 미확정 프레임이
  함께 있는 21개는 `mixed`, 나머지 1개는 `unverified`다.
