...
| 건물 상태 이미지 | 조선 본영·봉화대 본체 건설·정상·반파 범위와 K01 시작 building class 48/49/51/58/60/63의 identity·source·slot·catalog base frame 7 정적 확정. class 50 조선 훈련소는 generic primary body branch의 normal/nonzero `slot 108/configured offset 7/8`, state 8/9 selector와 renderer pair 소비까지 정적 확정했지만 `barrackk.spr` frame 9..15의 별도 overlay producer는 미확인 | 모든 진행도·50% 경계 및 opening building 11 record·catalog·SPR 변조 거부 재현 완료; class 50 primary normal/nonzero vector와 EXE/SPR/artifact 변조 거부 재현 완료 | K01 시작 building product binding 완료; class 49 본체는 별도 검증 범위, class 48/51/58/60/63은 base frame 7만 이식. class 50 frame 9..15 overlay는 미이식 | class 49 범위 밖 construction/damaged/overlay, class 50 overlay의 second draw producer·gate·cadence·loop·placement·compositor order, 모든 opening building timing/pivot/stats/commands/behavior/raw owner 의미 |
