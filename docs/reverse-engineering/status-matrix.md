...
| K01 시작 유닛 class 11·12·13·16·31 binding | K01 map active class 11·12·13·16·31 record, catalog 정체·primary SPR와 class 11·16 및 class 31 initializer/helper의 scoped core frame을 정적 확정 범위로 결합; class 31은 source-created `+0x47a==0` state 8/1/7만 포함 | canonical function·initializer·map·SPR 변조 거부와 record·frame vector 재현 완료 | class 31 `japanese-farmer`의 idle/move/walk/death 고유 visual을 부분 이식; gameplay/stats/commands는 gunner project adapter 유지 | class 31 state 4·nonzero branch, class 7 core states, source building proxy, stats/owner/movement을 별도 정적 분석 |
...
| 애니메이션 | K01 class 2·3·4·11·12·13·16·31·82 scoped core states, class 14 상태 8/1/4와 16-ring·transient destruction, 두 영웅 상태 1·4·7·8 정적 확정; class 31은 state 8/1/7 zero branch만 포함 | 방향·phase·상태별 슬롯·flags, class 14 turn/effect tick 경계와 K01 영웅 사망 완료/해제 경계 재현 | class 31 idle/move/walk/death와 class 2·3·4·11·12·13·14·16·82 grid 핵심 상태, 두 영웅 핵심 상태 이식 | class 31 state 4/nonzero branch, class 7 core states, class 2/3/4·12 state 2 project policy, 원본 update→FPS/24 Hz 변환, source building proxies |
