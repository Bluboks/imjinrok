...
원본 픽셀 색을 사용한다. 이 색은 `pal/imjin2.pal`
(`5ba2c020e9bd89210a10550fb4baaee8ab8bb316d4a2c7e66bdb24c6c8c4323b`)을 6-bit에서 8-bit RGB로
확장한 결과이며, 웹 PNG의 RGB literal도 같은 fixture가 검증한다.

| 국가 | mask 색 index | pixel 수 | bounding box | selection index | source nation 값 |
| --- | ---: | ---: | --- | ---: | ---: |
| 조선 | `0x44` / `(0,202,0)` | 33,492 | `(431,28)-(612,346)` | 0 | 1 |
| 일본 | `0x46` / `(202,202,0)` | 19,518 | `(517,72)-(613,342)` | 1 | 2 |
| 명 | `0x45` / `(202,0,0)` | 23,891 | `(320,59)-(445,350)` | 2 | 3 |
