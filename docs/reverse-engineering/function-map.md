...
| `0x00456329`, `0x0045633c`, `0x00455937` | resource flow visual-state writers | raw visual state 10/11/16 writes | selector 1/2→10, selector 3→11, alternate routine path→16 | class 7/31 resource-work consumer에 연결되는 raw state 값만 정적 확정; selector 이름·state-16 internal condition·사람용 행동명은 미확인 |
