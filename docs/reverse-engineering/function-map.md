...
| `0x0041efa0` | `FUN_0041efa0` | 점프 테이블 포함 | 내부 클래스 2의 상태 1 방향·phase→frame·mirror | 정적 확정 범위는 애니메이션 파일럿 참조 |
...
| `0x004291d0` | `FUN_004291d0` | 클래스 점프 테이블 포함 | 내부 클래스별 애니메이션 설정 초기화 | class 2와 class 49 본체 경로 정적 확정 |
...
| `0x00443360` | `FUN_00443360` | 자원 순회 | 경로 포인터 표→런타임 스프라이트 레코드 로드 | 슬롯 100·141 경로 정적 확정 |
...
| `0x0045bf50` | `FUN_0045bf50`, `0x0045bf50-0x0045efb9` | 1 / 5,100 | 전체 엔티티 타입 정의 초기화 | class 2·49 인수와 이름 포인터 정적 확정 |
