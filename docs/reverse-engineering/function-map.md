...
| `0x00447360` | `FUN_00447360`, `0x00447360-0x00447599` | 35 / 156 | active entity list 뒤 투사체 slot 0~99 순회 | entity dispatcher 반환 0→`0x00483aa0`, subtype `0x0c` pool 범위 정적 확정. class 50 primary phase scope에서는 active-list `slot*0x558+0x00635258`→`0x0043c9c0` caller edge 정적 확정 |
