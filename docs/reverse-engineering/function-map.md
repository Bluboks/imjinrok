...
| `0x0046a530` | `FUN_0046a530`, `0x0046a530-0x0046a8e8` | ? / 299 | per-cell family byte+`0x3c`→common fog record, state별 3×2 compositor | fog records 60..74, black 75, two call paths and six subframes are 정적 확정; frame index algebra/scheduling/pixel placement are 미확정 |
