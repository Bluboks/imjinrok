...
| `0x00469330`, `0x00469510`, `0x0046d650` | `FUN_00469330`, `FUN_00469510`, `FUN_0046d650` | ? / 150; ? / 341; ? / 50 | K01 signed x/y→`+0x32514` low-nibble branch→helper placement-level selector and `+0x3a3a4/+0x42234` object/frame bytes | K01 3,600 cells: helper result 0; low nibble 2 is 2,865 cells/shift 0 and other is 735/shift 16; object/frame source/header bound 정적 확정. height/elevation human meaning, axis/pivot and product renderer parity are 미확정 |
