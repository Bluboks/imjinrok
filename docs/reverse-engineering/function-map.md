...
| `0x00449090` | `FUN_00449090`, `0x00449090-0x00449260` | 26 / 118 | UI 상태 switch; `0x3f0` 목표 모달 초기화, `0x3f1` 갱신·종료·해제 | 공통 목표 모달 소유 생명주기는 정적 확정; `0x3f0`의 상위 return-value/간접 생산 경로와 K01 결합은 미확정 |
...
| `0x004a5730` | `FUN_004a5730`, `0x004a5730-0x004a5977` | 13 / 157 | `objectiveborder.spr` 로드, 닫기 컨트롤 `(415,267)` 80×24 초기화, 내용 clear와 두 텍스트 배치 | 목표 모달 초기화·로드·텍스트 실패 분기 정적 확정, 입력 문자열 의미·글꼴 미확정 |
