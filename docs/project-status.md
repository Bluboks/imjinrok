...
| 애니메이션 | 조선 창병 일반 이동, class 7·31 carry/carry-idle와 generic `gather`의 original state-10-only adapter, class 13 일본 사무라이와 권율·유성룡 idle·일반 이동·공격·사망 이식 | 클래스 2 상태 1·2 이동, class 7·31 state 8·1·7·10·11·16, 클래스 13·76·78 상태 1·4·7·8과 영웅 사망 phase/update-unit 수명 확정 | 방향·phase·상태별 슬롯·flags·class 7·31 nonzero/resource-work 96-vector·사망 완료/해제 경계 테스트 | generic `gather`는 state 10에만 의도적 적응; state 11/16 product mapping·사람용 의미·selector identity와 원본 update→FPS/24 Hz, opt-in 사망 수명 이식 미확정 |
