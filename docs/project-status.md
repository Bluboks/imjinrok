...
복원해 이식했다. 다만 재생 속도, 타격 시점과 현재 시뮬레이션의 사망 엔티티 제거 시점은 아직
원본 기반이 아니다.
...
| 애니메이션 | 조선 창병 일반 이동과 권율·유성룡 idle·일반 이동·공격·사망 이식 | 클래스 2 상태 1·2 이동, 클래스 76·78 상태 1·4·7·8의 슬롯·프레임·방향식 확정 | 8방향·phase·상태별 슬롯·flags 분기·입력 해시 테스트 | 영웅 핵심 상태 프레임 원본 기반, 재생 속도·타격 시점·사망 표시 수명과 조선 창병 상태 2 통합 미확정 |
...
1. 공격 phase와 실제 피해 적용 시점, 재사용 대기, 피격·사망 수명주기를 정적으로 복원
2. 조선 창병의 공격 상태와 K01 핵심 전투 주기를 정적으로 복원
