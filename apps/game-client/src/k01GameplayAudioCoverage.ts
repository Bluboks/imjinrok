...
export const K01_GAMEPLAY_AUDIO_COVERAGE = [
  ...
  { kind: "gwon-yul", status: "unresolved", actions: [], evidenceDocument: "docs/reverse-engineering/mechanics/k01-hero-animation-pilot.md", note: "No exact hero voice-family identity adapter is established." },
  ...
  { kind: "ryu-seong-ryong", status: "unresolved", actions: [], evidenceDocument: "docs/reverse-engineering/mechanics/k01-hero-animation-pilot.md", note: "No exact hero voice-family identity adapter is established." },
