...
const k01SourceOpeningAdapterRecords = [
  ...
  { originalClass: 4, rawOwnerWord: 0, offset: { x: 8, y: 2 }, projectKind: "archer", identityMapping: "exact-static-identity-source", idSuffix: "source-0x04-14-8" },
  { originalClass: 7, rawOwnerWord: 0, offset: { x: 1, y: 0 }, projectKind: "villager", identityMapping: "exact-static-identity-source", idSuffix: "source-0x07-7-6" },
  { originalClass: 7, rawOwnerWord: 0, offset: { x: 2, y: 0 }, projectKind: "villager", identityMapping: "exact-static-identity-source", idSuffix: "source-0x07-8-6" },
  ...
  { originalClass: 11, rawOwnerWord: 0, offset: { x: 1, y: 4 }, projectKind: "korean-monk", identityMapping: "exact-static-identity-source", idSuffix: "source-0x0b-7-10" },
  ...
  { originalClass: 31, rawOwnerWord: 1, offset: { x: -45, y: -4 }, projectKind: "japanese-farmer", identityMapping: "exact-static-identity-source", idSuffix: "source-0x1f-7-48" },
  { originalClass: 31, rawOwnerWord: 1, offset: { x: -45, y: -5 }, projectKind: "japanese-farmer", identityMapping: "exact-static-identity-source", idSuffix: "source-0x1f-7-47" },
  { originalClass: 31, rawOwnerWord: 1, offset: { x: -4, y: -51 }, projectKind: "japanese-farmer", identityMapping: "exact-static-identity-source", idSuffix: "source-0x1f-48-1" },
