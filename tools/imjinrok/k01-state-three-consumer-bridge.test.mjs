...
test("replays scheduler short-circuit, exact raw23 source domain, and result consumers", () => {
  ...
  assert.deepEqual(replayRaw23Bridge({ currentStateWord: 23, schedulerModeWord: 0, pollSourceOutcomeDword: 8, externalModeDword: 0 }), { currentStateWord: 0x8c, targetStateWord: 8, schedulerCalled: false, pollOutcome: 8, dispatchSkipped: false, branch: "source-8-fallthrough" });
