...
const EVIDENCE_POINTS = [
  ...
  [0x0043ce9a, "e8 71 76 fe ff", "credit gate calls the player-bank credit routine"],
  [0x0042453c, "66 01 14 45 cc 41 bb 00", "selector 3 credits the player-bank table with quantity shifted by 8"],
  [0x00424563, "66 01 14 45 cc 41 bb 00", "selectors 1 and 2 credit the player-bank table with quantity"],
