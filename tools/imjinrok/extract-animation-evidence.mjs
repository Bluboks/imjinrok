...
export const ANIMATION_STATIC_EVIDENCE = [
  {
    ...
    va: 0x0040174c,
    bytes: "0f bf 4e 08",
    meaning: "small draw-record path reads WORD [record+0x08] as its sprite slot",
  },
  {
    ...
    va: 0x0040179f,
    bytes: "0f bf 56 0a",
    meaning: "small draw-record path reads WORD [record+0x0a] as its frame index",
  },
  {
    ...
    meaning: "small draw-record path loads the selected runtime sprite record data base",
  },
  {
  ...
  },
  {
    ...
    category: "sprite-slot-setter-candidate",
    va: 0x0041d470,
  ...
  },
  {
    ...
    va: 0x0041d4b1,
    bytes: "66 89 41 0a",
    meaning: "candidate state path writes the main entity sprite slot +0x0a from +0x456",
  },
  {
  ...
  },
  {
    ...
    va: 0x0041d5be,
    bytes: "66 89 41 0a",
    meaning: "candidate state path writes the main entity sprite slot +0x0a from +0x48e",
  },
  {
  ...
  },
  {
    ...
    category: "literal-sprite-slot-seed-candidate",
    va: 0x0042c80a,
    bytes: "66 c7 41 0a 6a 00",
    meaning: "candidate mode/state initializer writes sprite slot 0x006a to WORD [entity+0x0a]",
  },
  {
    ...
    meaning: "candidate mode/state initializer writes sprite slot 0x00cc to WORD [entity+0x0a]",
  },
  {
    ...
    meaning: "candidate mode/state initializer writes sprite slot 0x006e to WORD [entity+0x0a]",
  },
  {
...
export const DRAW_RUNTIME_CAPTURE_FIELDS = [
  "esi small draw-record pointer",
  "WORD [esi+0x08] sprite slot",
  "WORD [esi+0x0a] frame index",
