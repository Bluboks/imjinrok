...
const CODE_ANCHORS = [
  ...
  ["screen-rect-clear-pivot-footprint-width", 0x00438939, "8a 8e e3 01 00 00", "FUN_00438930 reads signed runtime footprint width BYTE entity +0x1e3 for the far occupied cell"],
  ["screen-rect-clear-pivot-footprint-height", 0x0043895d, "8a 8e e4 01 00 00", "FUN_00438930 reads signed runtime footprint height BYTE entity +0x1e4 for the far occupied cell"],
  ["screen-rect-clear-pivot-spr-pixel-dimensions", 0x00438990, "66 8b 88 bc c0 88 00 66 89 8e da 01 00 00 66 8b 80 c0 c0 88 00 66 89 86 dc 01 00 00", "FUN_00438930 copies SPR slot pixel width/height into runtime WORD fields +0x1da/+0x1dc"],
  ["screen-rect-clear-pivot-flag-split", 0x004389ac, "8a 46 74 a8 08 74 66", "FUN_00438930 branches on low-byte flags bit 0x08"],
  ["screen-rect-centered-pivot-footprint-width", 0x00438aa1, "8a 99 e3 01 00 00", "FUN_00438aa0 reads signed runtime footprint width BYTE entity +0x1e3 for the far occupied cell"],
  ["screen-rect-centered-pivot-footprint-height", 0x00438abe, "8a 99 e4 01 00 00", "FUN_00438aa0 reads signed runtime footprint height BYTE entity +0x1e4 for the far occupied cell"],
  ["screen-rect-centered-pivot-spr-pixel-dimensions", 0x00438af2, "66 8b 90 bc c0 88 00 66 89 91 da 01 00 00 66 8b 80 c0 c0 88 00 66 89 81 dc 01 00 00", "FUN_00438aa0 copies SPR slot pixel width/height into runtime WORD fields +0x1da/+0x1dc"],
...
export function extractOriginalEntityVisualProfiles({
  ...
  return {
    ...
    renderer: {
      ...
      pivotFormula: "flags low-byte bit 0x08 clear => (current SPR pixel width/2, current SPR pixel height - signed type record +0x0c); set => (current SPR pixel width/2, current SPR pixel height/2)",
      nativeDimensionFields: {
        footprintWidth: "entity +0x1e3 signed BYTE (far occupied-cell extent; not SPR pixel width)",
        footprintHeight: "entity +0x1e4 signed BYTE (far occupied-cell extent; not SPR pixel height)",
        pixelWidth: "entity +0x1da signed WORD copied from SPR slot table globals +0x88c0bc with stride 0xbf8",
        pixelHeight: "entity +0x1dc signed WORD copied from SPR slot table globals +0x88c0c0 with stride 0xbf8",
      },
